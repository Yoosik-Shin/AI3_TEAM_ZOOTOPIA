...
('고양이 사료'- 생선 맛', '사료', '신선한 생선을 주원료로 한 고양이 사료입니다.', 32000, '/assets/dist/img/products/foodcatfishtaste.png', 10),
...
('개&고양이 건조 사료', '사료', '개와 고양이 모두 먹을 수 있는 건조 사료입니다.', 45000, '/assets/dist/img/products/fooddogandcatdried.png', 10),
('개&고양이 습식 사료', '사료', '수분이 풍부한 습식 사료로 기호성이 뛰어납니다.', 48000, '/assets/dist/img/products/fooddogcatmoistured.png', 10),
('개 사료'- 껌1', '사료', '개의 치아 건강을 위한 껌 형태의 사료입니다.', 18000, '/assets/dist/img/products/fooddoggum1.png', 10),
('개 사료'- 하트빔', '사료', '하트 모양의 귀여운 개 사료입니다.', 25000, '/assets/dist/img/products/fooddogheartbeam.png', 10),
('개 사료'- 고기', '사료', '신선한 고기를 주원료로 한 프리미엄 개 사료입니다.', 55000, '/assets/dist/img/products/fooddogmeat.png', 10),
...
('개 물그릇', '용품', '개 전용 물그릇입니다. 넘어지지 않도록 닥에 미끄럼 방지 처리가 되어 있습니다.', 15000, '/assets/dist/img/products/productdogwaterbowl.png', 10),
...
('펫 빗', '용품', '반려동물의 털을 정리하는 빗입니다.', 2000, '/assets/dist/img/products/productpetcomb.png', 10),
...
UPDATE products SET image_url = '/assets/dist/img/products/productpetcousion.png' WHERE name = '펫 쿠션';
UPDATE products SET image_url = '/assets/dist/img/products/productpetcutter.png' WHERE name = '펫 발톱깎이';
UPDATE products SET image_url = '/assets/dist/img/products/productpetearcleaner.png' WHERE name = '펫 귀 청소용품';
UPDATE products SET image_url = '/assets/dist/img/products/productpethouse.png' WHERE name = '펫 하우스';
UPDATE products SET image_url = '/assets/dist/img/products/productpetnecklace.png' WHERE name = '펫 목걸이';
UPDATE products SET image_url = '/assets/dist/img/products/productpetshampoo.png' WHERE name = '펫 샴푸';
UPDATE products SET image_url = '/assets/dist/img/products/productpetcarriage.png' WHERE name = '펫 캐리어';
