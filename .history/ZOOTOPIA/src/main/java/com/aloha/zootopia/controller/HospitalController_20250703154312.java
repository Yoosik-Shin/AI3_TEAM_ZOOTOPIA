...
public class HospitalController {
    ...
    public String list(@RequestParam(required = false) List<Integer> animal, Model model) {
        ...
        List<Hospital> hospitals = hospitalService.getHospitals(animal);
        model.addAttribute("hospitals", hospitals);
        model.addAttribute("animalList", hospitalService.getAllAnimals());
        model.addAttribute("selectedAnimals", animal);
        return "service/hospital/hosp_list";
    }

    @GetMapping("/hospitals")
    public String listHospitals(@RequestParam(required = false) List<Integer> animal, Model model) {
