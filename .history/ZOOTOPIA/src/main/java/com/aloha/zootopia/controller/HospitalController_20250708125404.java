...
public class HospitalController {
    ...
    public ResponseEntity<?> create(@ModelAttribute HospitalForm form, @RequestParam(value = "thumbnailImageFile", required = false) MultipartFile thumbnailImageFile) throws Exception {
    ...
    public ResponseEntity<?> update(@ModelAttribute HospitalForm form, @RequestParam(value = "thumbnailImageFile", required = false) MultipartFile thumbnailImageFile) throws Exception {
        if (thumbnailImageFile != null && !thumbnailImageFile.isEmpty()) {
            String imageUrl = hospitalImageUploader.uploadFile(thumbnailImageFile);
            form.setThumbnailImageUrl(imageUrl);
        }
