...
public HospitalServiceImpl(HospitalMapper hospitalMapper) {
    ...
    @Override
    public PageInfo<Hospital> getHospitalList(int pageNum, int pageSize, List<Long> animalIds, PageInfo pageInfo) {
    ...
    @Override
    public int getHospitalCount(List<Long> animalIds) {
