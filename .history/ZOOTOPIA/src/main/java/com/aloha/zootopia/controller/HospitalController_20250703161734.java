...
public class HospitalController {
    ...
    public String list(@RequestParam(required = false) List<Integer> animalIds, Model model,
        ...
        return hospitalService.getHospitals(animal, pageNum, pageSize);
        // "service/hospital/hosp_list";
    }
